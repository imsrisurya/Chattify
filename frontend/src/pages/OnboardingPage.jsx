...
import { Camera, Shuffle, MapPinIcon, ShipWheelIcon, LoaderIcon } from "lucide-react";
    ...
    <div className="min-h-screen bg-base-100 flex items-center justify-center p-4">
      <div className="card bg-base-200 w-full max-w-2xl shadow-xl">
        <div className="card-body p-6 sm:p-8">
          <h1 className="text-2xl sm:text-2xl font-bold text-center mb-2">Complete Your Profile</h1>
          <form onSubmit={handleSubmit} className="space-y-3 text-sm">
            ...
            <div className="flex flex-col items-center justify-center space-y-2">
                ...
                <button
                  ...
                  className="btn btn-accent btn-sm w-fit px-4"
