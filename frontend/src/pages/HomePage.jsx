...
import { getRecommendedUsers, getUserFriends, getOutgoingFriendReqs, sendFriendRequest, getFriendRequests } from '../lib/api';
import { Link } from "react-router";
import { UsersIcon, CheckCircleIcon, UserPlusIcon } from "lucide-react";
        ...
        <section>
          ...
          {loadingUsers ? (
            ...
            <div className="card bg-base-200 p-6 text-center">
              <h3 className="front-semibold text-lg mb-2">No Reccomendations available</h3>
